        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> 8340270054</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> asif@gmail.com</a></li>
                        ...
                        <div class="header-search">
                            <form action="{{route('user.search')}}" method="get">
                                <div class="custom_search_top" >
                                    ...
                                    <button style="background-color:blue;" class="search-btn">Search</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row" >
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <p>Btech 3rd Year student and Backend Developer</p>
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>Jalandhar</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>8340270054</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>asif@email.com</a></li>
                            </ul>
                        </div>
                    </div>
